Bilgisayarınıza kodları görüntüleyip çalıştırabileceğiniz bir ide yüklenmesi önerilir(tercihen vscode). Bu madde zorunlu değildir. cmd.exe üzerinden de kodlar çalıştırılabilir.
